...
class CustomCallback(BaseCallback):
    ...
    Attributes:
        env_wrapper: The environment wrapper to access additional data.
...
def train_ppo(env, action_type, log_path, model_path, total_timesteps=int(2e4), mode="train"):
    """
    ...
    callback = CustomCallback(env_wrapper=env, action_type=action_type, verbose=1)
...
if __name__ == "__main__":
    ...
    model = train_ppo(env, action_type, log_path, model_path, mode=mode)
